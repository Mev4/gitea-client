package dev.mev4.gitea.client;

import com.google.gson.Gson;
import com.google.gson.JsonParseException;
import dev.mev4.gitea.client.auth.ApiKeyAuth;
import dev.mev4.gitea.client.auth.HttpBasicAuth;
import dev.mev4.gitea.client.auth.OAuth;
import dev.mev4.gitea.client.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
  ...
  public ApiClient setApiKey(String apiKey) {
    for (Interceptor apiAuthorization : apiAuthorizations.values()) {
      if (apiAuthorization instanceof ApiKeyAuth keyAuth) {
  ...
  public ApiClient setCredentials(String username, String password) {
    for (Interceptor apiAuthorization : apiAuthorizations.values()) {
      if (apiAuthorization instanceof HttpBasicAuth basicAuth) {
        basicAuth.setCredentials(username, password);
        return this;
      }
      if (apiAuthorization instanceof OAuth oauth) {
